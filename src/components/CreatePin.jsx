      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-[420px]">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transtion-all duration-500 ease-in-out"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          <input
            ...
            placeholder="Add your titles here"
          ...
          <div className="flex flex-col">
            <div>
              ...
              <select
                ...
                name=""
                id=""
                className="outline-none w-4/5 text-base border-b-2 border-grey-200 p-2 rouneded-md cursor-pointer"
              >
